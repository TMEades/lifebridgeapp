...
const SignUpPage = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    if (email.endsWith('@gmail.com')) {
      toast({
        title: 'Use Google Sign Up',
        description: "To sign up with a Gmail account, please use the 'Sign up with Google' button for a secure and easy experience.",
        variant: 'default',
      });
      return;
    }
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up - LifeBridge</title>
        <meta name="description" content="Create an account to join the LifeBridge community." />
      </Helmet>
